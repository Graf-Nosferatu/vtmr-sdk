/**
 * Effect DiscEyesOfTheSerpent script.
...
public class EffectDiscEyesOfTheSerpent extends Codex
{
	private int				padGuid;

	// --------------------------------------------------------------------------------------------

	public EffectDiscEyesOfTheSerpent()
	{
	}
	...
	public void effectstarted(int actorGuid, int effectGuid, int creatorGuid, int duration)
	{
		...
		// Running pad effect
		padGuid = _Target.SpawnThing("ringOfSerpentsGreen");
