/**
 * Effect DiscTheForgetfulMind script.
...
public class EffectDiscTheForgetfulMind extends Codex
{
	private int				padGuid;

	// --------------------------------------------------------------------------------------------

	public EffectDiscTheForgetfulMind()
	{
	}
	...
	public void effectstarted(int actorGuid, int effectGuid, int creatorGuid, int duration)
	{
		...
		// Running pad effect
		padGuid = _Target.SpawnThing("ankhsPadYellow");
