/**
 * Effect DiscEntrancement script.
...
public class EffectDiscEntrancement extends Codex
{
	private int				padGuid;

	// --------------------------------------------------------------------------------------------

	public EffectDiscEntrancement()
	{
	}
	...
	public void effectstarted(int actorGuid, int effectGuid, int creatorGuid, int duration)
	{
		...
		// initial effect
		_Target.SpawnThing("flamewave");
		
		// running pad effect
		padGuid = _Target.SpawnThing("ringOfEyesBlue");
