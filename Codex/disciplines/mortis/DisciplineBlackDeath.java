...
public class DisciplineBlackDeath extends Discipline
{
	private static final String	DISCIPLINE_NAME	= "BlackDeath";

	// --------------------------------------------------------------------------------------------

	public DisciplineBlackDeath()
	{
	}
	...
	public int cast(int level, int casterGuid, int targetGuid)
	{
		...
		try
		{
			...
			targetThing.AddActorEffectByLevel("ef_disc_blackdeath", 4000, level, casterGuid, EI_FLAG_DISCIPLINE);
