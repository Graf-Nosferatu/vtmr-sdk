/**
 * Discipline Aura Perception script.
...
public class DisciplineAuraPerception extends Discipline
{
	private static final String	DISCIPLINE_NAME	= "AuraPerception";
	...
	public DisciplineAuraPerception()
	{
	}
	...
	public int cast(int level, int casterGuid, int targetGuid)
	{
		...
		try
		{
			targetThing.AddActorEffectByLevel("ef_disc_auraperception", 0, 0, casterGuid, EI_FLAG_DISCIPLINE);
