/**
 * Discipline CallLightning script.
...
public class DisciplineCallLightning extends Discipline
{
	private static final String	DISCIPLINE_NAME	= "CallLightning";

	// --------------------------------------------------------------------------------------------

	public DisciplineCallLightning()
	{
	}
	...
	public int cast(int level, int casterGuid, int targetGuid)
	{
		...
		try
		{
			...
			targetThing.AddActorEffectByLevel("ef_disc_calllightning", 1, level-1, casterGuid, EI_FLAG_DISCIPLINE);
