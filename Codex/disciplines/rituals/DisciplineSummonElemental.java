/**
 * Discipline SummonElemental script.
...
public class DisciplineSummonElemental extends Discipline
{
	private static final String	DISCIPLINE_NAME	= "SummonElemental";

	// --------------------------------------------------------------------------------------------

	public DisciplineSummonElemental()
	{
	}
	...
	public int cast(int level, int casterGuid)
	{
		...
		try
		{
			int petGuid = casterThing.SpawnThingNear("elemental", 0.0f, 0);
			if(petGuid != 0)
			{
				...
				// start the effect
				petActor.AddActorEffectByLevel("ef_disc_summonelemental", SUMMONELEMENTAL_DURATIONS[level], level, casterGuid, EI_FLAG_DISCIPLINE);
