/**
 * Effect DiscVoiceOfMadness script.
...
public class EffectDiscVoiceOfMadness extends Codex
{
	private int				padGuid;

	// --------------------------------------------------------------------------------------------

	public EffectDiscVoiceOfMadness()
	{
	}
	...
	public void effectstarted(int actorGuid, int effectGuid, int creatorGuid, int duration)
	{
		...
		// running ring effect
		padGuid = _Target.SpawnThing("ringOfSkullsYellow");
