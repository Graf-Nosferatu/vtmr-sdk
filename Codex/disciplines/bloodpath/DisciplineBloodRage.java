...
public class DisciplineBloodRage extends Discipline
{
	private static final String	DISCIPLINE_NAME	= "BloodRage";

	// --------------------------------------------------------------------------------------------

	public DisciplineBloodRage()
	{
	}
	...
	public int cast(int level, int casterGuid, int targetGuid)
	{
		...
		try
		{
			...
			targetThing.AddActorEffectByLevel("ef_disc_bloodrage1", 2000, level, casterGuid, EI_FLAG_DISCIPLINE);
			targetThing.AddActorEffectByLevel("ef_disc_bloodrage2", 2000, level, casterGuid, EI_FLAG_DISCIPLINE);
