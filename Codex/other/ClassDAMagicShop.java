/**
 * ClassDAMagicShop script.
 * <BR>Copyright (c) Nihilistic Software, Inc. 1998-1999
 *
 * @author Sthoms
*/

public class ClassDAMagicShop extends Codex
{
	private CodexActor	owner;

	private String				descriptionID			= "GEN_DA_MAGICSHOP";
	private int					flags					= 0;
	...
	{
		AddBuySell("generic_DA_magic.nbs", GetClassThing(), descriptionID, flags, buyRate, sellRate, sellFlags);
