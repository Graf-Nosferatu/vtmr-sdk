/**
 * ClassDAWeapShop script.
 * <BR>Copyright (c) Nihilistic Software, Inc. 1998-1999
 *
 * @author Sthoms
*/

public class ClassDAWeapShop extends Codex
{
	private CodexActor	owner;

	private String				descriptionID			= "GEN_DA_WEAPSHOP";
	private int					flags					= 0;
	...
	{
		AddBuySell("generic_DA_weapon.nbs", GetClassThing(), descriptionID, flags, buyRate, sellRate, sellFlags);
