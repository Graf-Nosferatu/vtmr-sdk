...
public class ItemUtilityTorch extends Codex
{
	...
	public ItemUtilityTorch()
	{
	}

	public void CreateTorch()
	{
		CodexThing torch = new CodexThing(GetClassThing());

		flameGuid = torch.SpawnThing("torchFlame_nosave");
		int boneNum = torch.FindBone(MOTIONTAG_USER0);

		float[] offset = new float[3];
		offset = torch.FindBoneOffset(MOTIONTAG_USER0);

		torch.AttachThing(flameGuid, boneNum, offset, ATTACH_FLAG_AUTOREMOVE);
	}
